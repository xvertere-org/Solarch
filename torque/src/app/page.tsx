...
const features = [
  ...
  { icon: <Braces className="size-5" />, title: 'TypeScript Export', desc: 'Export workflows as self-contained .ts files with an inline executor. Run with npx tsx, bun, or deno.' },
  { icon: <Server className="size-5" />, title: 'TspoonBase Sync', desc: 'Optionally connect your TspoonBase instance to push workflows directly to your backend for production execution.' },
  { icon: <Moon className="size-5" />, title: 'Dark Theme', desc: 'Built with shadcn/ui and framer-motion. Beautiful dark theme with smooth spring animations.' },
      ...
      <section className="max-w-3xl mx-auto px-4 py-16 text-center">
        <div className="rounded-xl border border-border bg-card p-10">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-md mx-auto">
            Sign in with GitHub or Google to access the canvas and start designing workflows.
          </p>
          <Link href="/canvas">
