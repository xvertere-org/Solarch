  ...
  return (
    <article>
      ...
      <DocSection id="quick-start" title="Quick Start">
        <p className="mb-6 text-theme-secondary">
          Choose your preferred way to run Solarch. All three methods give you the same
      ...
      <DocSection id="installation" title="Installation">
        <div className="mb-6 flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/5 px-4 py-3">
          ...
          <p className="text-sm text-theme-secondary">
            ...
            . Solarch is tested on Node 20, 22, and the latest LTS.
          </p>
        </div>
        ...
        <div className="overflow-hidden rounded-xl border border-theme">
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {[
                { method: 'npm (global)', cmd: 'npm install -g solarch' },
                { method: 'yarn (global)', cmd: 'yarn global add solarch' },
                { method: 'pnpm (global)', cmd: 'pnpm add -g solarch' },
                { method: 'npx (no install)', cmd: 'npx solarch serve --dev' },
                { method: 'Docker', cmd: 'docker pull solarch/solarch:latest' },
              ].map((row, idx) => (
                <tr
                  key={row.method}
    ...
    style C fill:#1a6fff,color:#fff`}
      ...
      <DocSection id="cli-commands" title="CLI Commands">
        <p className="mb-6 text-theme-secondary">
          Solarch ships with a powerful CLI for scaffolding, serving, and managing your backend.
        </p>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mb-3 text-sm text-theme-tertiary">
              Start the Solarch server. Use <code className="rounded bg-theme-muted px-1 py-0.5 text-xs text-primary">--dev</code> for development with hot reload and verbose logging.
            </p>
            <CodeBlock
              lang="bash"
...
# ✓ Superuser created successfully`}
          ...
          <div>
            ...
            <p className="mb-3 text-sm text-theme-tertiary">
              Manage database migrations. Solarch auto-generates migration files from your collection changes.
            </p>
            <CodeBlock
              lang="bash"
...
solarch migrate status`}
    ...
    style G fill:#1a6fff,color:#fff`}
        ...
        <ol className="space-y-6">
          {[
            {
              title: 'Install Solarch globally',
            ...
            },
            {
              ...
              code: 'solarch serve --dev --port 8090',
              lang: 'bash' as const,
            },
            {
              ...
              code: 'solarch superuser-create admin@example.com secret123',
              lang: 'bash' as const,
            },
            {
  ...
  schema: [
    ...
    { name: 'published', type: 'bool', default: false },
      ...
      <DocSection id="project-structure" title="Project Structure">
        <p className="mb-6 text-theme-secondary">
          Solarch follows a convention-over-configuration approach. These directories are
...
└── solarch.config.ts`}
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
          {[
            ...
            {
              dir: 'pb_migrations/',
              desc: 'Timestamped migration files. Solarch auto-generates these when you change schemas.',
            },
            {
              dir: 'pb_hooks/',
      ...
      <DocSection id="agent-skill" title="Agent Skill">
        <p className="mb-6 text-theme-secondary">
          Drop this skill into your AI coding agent and it instantly understands Solarch —
        ...
        <div className="mb-6 overflow-hidden rounded-xl border border-theme bg-theme-surface">
          ...
          <CodeBlock
            code={`mkdir -p .claude/skills/solarch && curl -fsSL https://raw.githubusercontent.com/Jay-Suryawansh7/solarch/main/public_site/solarch-agent-skill.md -o .claude/skills/solarch/SKILL.md`}
            lang="bash"
            filename="terminal"
          />
        </div>
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-3">
          {[
            {
              name: 'Claude',
              path: '.claude/skills/solarch/SKILL.md',
              cmd: 'mkdir -p .claude/skills/solarch && curl -fsSL https://raw.githubusercontent.com/Jay-Suryawansh7/solarch/main/public_site/solarch-agent-skill.md -o .claude/skills/solarch/SKILL.md',
              color: 'bg-orange-500/10 text-orange-400 border-orange-500/20',
            },
            {
              name: 'Codex',
              path: '.agent/skills/solarch/SKILL.md',
              cmd: 'mkdir -p .agent/skills/solarch && curl -fsSL https://raw.githubusercontent.com/Jay-Suryawansh7/solarch/main/public_site/solarch-agent-skill.md -o .agent/skills/solarch/SKILL.md',
              color: 'bg-blue-500/10 text-blue-400 border-blue-500/20',
            },
            {
              name: 'Cursor',
              path: '.cursor/rules/solarch.mdc',
              cmd: 'mkdir -p .cursor/rules && curl -fsSL https://raw.githubusercontent.com/Jay-Suryawansh7/solarch/main/public_site/solarch-agent-skill.md -o .cursor/rules/solarch.mdc',
        ...
        <div className="mb-6 text-center text-sm text-theme-tertiary">
          or{' '}
          <a
            href="https://raw.githubusercontent.com/Jay-Suryawansh7/solarch/main/public_site/solarch-agent-skill.md"
      ...
      <DocSection id="changelog" title="Changelog">
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-theme bg-theme-surface p-4">
            ...
            <ul className="mt-1 list-inside list-disc space-y-1 text-sm text-theme-secondary">
              <li><code>solarch init</code> CLI command — interactive project scaffolding</li>
              <li>Select database, auth providers, rate limiting, AI tools during setup</li>
              <li>Generates <code>.env</code>, <code>solarch.config.ts</code>, <code>pb_migrations/</code>, and optional <code>docker-compose.yml</code></li>
            </ul>
          </div>
          <div className="rounded-lg border border-theme bg-theme-surface p-4">
          ...
          <div className="rounded-lg border border-theme bg-theme-surface p-4">
            ...
            <ul className="mt-1 list-inside list-disc space-y-1 text-sm text-theme-secondary">
              <li>JWT secret now reads from <code>JWT_SECRET</code> or <code>SOLARCH_JWT_SECRET</code> env var first</li>
              <li>All auth code now uses <code>app.getJwtSecret()</code> instead of <code>appName</code> fallback</li>
              <li>Encryption salt is now configurable via <code>SOLARCH_ENCRYPTION_KEY</code> env var</li>
          ...
          <div className="rounded-lg border border-theme bg-theme-surface p-4">
            ...
            <h4 className="mt-3 text-sm font-semibold text-green-400">Fixed</h4>
            <ul className="mt-1 list-inside list-disc space-y-1 text-sm text-theme-secondary">
              <li>Removed circular self-dependency (solarch depending on itself in package.json)</li>
