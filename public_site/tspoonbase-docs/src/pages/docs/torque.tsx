    ...
    <article>
      ...
      <DocSection id="overview" title="Overview">
        <p className="mb-4 text-theme-secondary">
          ...
          configure every parameter, and export the pipeline into your TspoonBase backend — where it becomes a
        ...
        <div className="mb-4 flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/5 px-4 py-3">
          ...
          <div className="text-sm text-theme-secondary">
            ...
            your TspoonBase instance via the API.
          </div>
        </div>
        ...
        <div className="overflow-hidden rounded-xl border border-theme bg-theme-surface">
          ...
          <CodeBlock
            code={`cd torque
npm install
cp .env.example .env  # set NEXT_PUBLIC_TSPOONBASE_URL
npm run dev           # → http://localhost:3000`}
        ...
        <p className="mt-4 text-theme-secondary">
          Point <code className="rounded bg-theme-muted px-1 py-0.5 text-xs">NEXT_PUBLIC_TSPOONBASE_URL</code> to your running
          TspoonBase instance (default <code className="rounded bg-theme-muted px-1 py-0.5 text-xs">http://localhost:8090</code>).
          The canvas fetches available node types from TspoonBase, or falls back to 48 built-in defaults.
        </p>
      </DocSection>
        ...
        {[
          {
            ...
            nodes: [
              ...
              ['Form Submit', 'Triggered when a TspoonBase collection record is created'],
          ...
          },
          {
            ...
            nodes: [
              ...
              ['File Upload', 'Upload to TspoonBase file storage'],
          ...
          },
          {
            ...
            nodes: [
              ...
              ['Save to Collection', 'Persist data to a TspoonBase collection'],
      ...
      <DocSection id="exporting" title="Exporting Workflows">
        <p className="mb-4 text-theme-secondary">
          ...
          to register the workflow with your TspoonBase instance via{' '}
          <code className="rounded bg-theme-muted px-1 py-0.5 text-xs">POST /api/agents/workflows/register</code>.
          If TspoonBase is not reachable, the workflow downloads as a JSON file.
        </p>
  ...
  "edges": [
    ...
    { "id": "e3", "from": "n3", "to": "n4", "sourceHandle": "response", "targetHandle": "input" }
      ...
      <DocSection id="api-endpoints" title="API Endpoints">
        <p className="mb-4 text-theme-secondary">
          Once exported, workflows are managed and executed through the TspoonBase agent API:
        </p>
